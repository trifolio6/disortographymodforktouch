...
QRectF LessonPainter::cursorRabbitRectangle() const
{
    return m_cursorRabbitRectangle;
}
...
void LessonPainter::updateCursorRectangle()
{
    ...
    m_cursorRabbitRectangle = QRectF(
                m_textScale * blockPos.x(),
                m_textScale * blockPos.y(),
                m_textScale * line.cursorToX(1),
                m_textScale * line.height());
    
    emit cursorRectangleChanged();
    emit cursorRabbitRectangleChanged();
}
