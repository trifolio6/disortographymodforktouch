...
class LessonPainter : public QDeclarativeItem
{
    ...
    Q_PROPERTY(QRectF cursorRabbitRectangle READ cursorRabbitRectangle NOTIFY cursorRabbitRectangleChanged)
public:
    ...
    QRectF cursorRabbitRectangle() const;
public slots:
    void reset();
signals:
    void lessonChanged();
    ...
    void cursorRabbitRectangleChanged();
    void topLeftChanged();
    void done();
protected:
...
private:
    ...
    QRectF m_cursorRabbitRectangle;
};
